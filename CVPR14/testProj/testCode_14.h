...
namespace ESRAligner {
  static void testLearnW(char *inputName)
  {
    //load data
  ...
  static vector<vector<int>> readData(char *inputName)
  {
  ...
  static void pridict(char *modelName)
  {
  ...
  static void pridict_direct14(char *modelName)
  {
  ...
  static void evaluation(int sampleNum = 5)
  {
    char testNameList[] = "D:\\Fuhao\\face dataset new\\faceRegression\\testset1\\ptsList.txt";
  ...
  static void evaluation_stepCheck()
  {
    char testNameList[] = "D:\\Fuhao\\face dataset new\\faceRegression\\testset1\\ptsList.txt";
  ...
  static void evaluation_GTCheck()
  {
  ...
  static void evaluation_ModelCheck()
  {
  ...
  static void pridict_real(char *modelName, int sampleNum = 5)
  {
  ...
  static void pridict_real_twoLevel(char *modelName, char *modelNameL2, int sampleNum = 5)
  {
  ...
  static void predict_direct(char *modelName, int sampleNum = 5)
  {
    TwoLevelRegression trainer;
    trainer.showRes = true;
    trainer.loadFerns_bin(modelName);
  ...
  static void prepareImages(char *nameList)
  {
    //char *nameList="D:\\Fuhao\\face dataset new\\faceRegression\\trainset\\ptsList.txt";
    TwoLevelRegression trainer;
  ...
  static void realtimeFace(char *modelName)
  {
    LocalGlobalRegression trainer;
    trainer.load_CVPR14(modelName);
