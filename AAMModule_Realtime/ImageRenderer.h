...
public:
	...
	HRESULT DrawImgOnly(BYTE* pImage, unsigned long cbImage);
	 //HRESULT Draw_new(BYTE* pImage, unsigned long cbImage,float *points);
	ShowImgPts *showImgPts;
private:
    HWND                     m_hWnd;
