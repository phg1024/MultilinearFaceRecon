...
extern "C" int iterate_combination_new(int width,int height,int currentFrame,int startFrame,float &theta,float &errorVal,float *shape=NULL,bool isAAMOnly=false,bool showNN=false,bool updateOnly=false);
